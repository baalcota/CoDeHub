...
namespace CoDeHub
{
    ...
    ///</summary>
    public class CoDeHub : Rhino.PlugIns.FileExportPlugIn
    {
        public CoDeHub()
        {
            Instance = this;
            Console.WriteLine("Testeando commit");
        }

        ///<summary>Gets the only instance of the MyRhinoPlugin1 plug-in.</summary>
        public static CoDeHub Instance { get; private set; }
        ...
        protected override Rhino.PlugIns.FileTypeList AddFileTypes(Rhino.FileIO.FileWriteOptions options)
        {
            ...
            result.AddFileType("Text file (*.txt)", "txt");
            return result;
        }

        /// <summary>
        /// Is called when a user requests to export a .txt file.
